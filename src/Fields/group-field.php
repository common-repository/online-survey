<?php
use OnlineSurvey\Fields\Group as RWMB_Group;
/**
 * Group field class.
 *
 * @package    Meta Box
...
class RWMB_Group_Field extends RWMB_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		foreach ( $fields as $field ) {
			if ( $field['clone'] ) {
				wp_enqueue_script( 'rwmb-clone', ONLINE_SURVEY_ASSETS . '/fields/clone.js', array( 'jquery-ui-sortable' ), RWMB_VER, true );
				break;
			}
		}
		...
		wp_enqueue_style( 'rwmb-group', ONLINE_SURVEY_ASSETS . '/fields/group.css', '', '1.3.14' );
		wp_enqueue_script( 'rwmb-group', ONLINE_SURVEY_ASSETS . '/fields/group.js', array( 'jquery', 'underscore' ), '1.3.14', true );
		wp_localize_script(
			'rwmb-group',
			'RWMB_Group',
			array(
