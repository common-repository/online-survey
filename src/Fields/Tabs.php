...
class Tabs {
		...
		public function enqueue() {		
			wp_enqueue_style( 'rwmb-tabs', ONLINE_SURVEY_ASSETS . '/fields/tabs.css', '', '1.1.12' );
			wp_enqueue_script( 'rwmb-tabs',  ONLINE_SURVEY_ASSETS . '/fields/tabs.js', array( 'jquery' ), '1.1.12', true );
		}
