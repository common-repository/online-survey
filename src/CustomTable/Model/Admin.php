<?php
namespace OnlineSurvey\CustomTable\Model;
...
class Admin {
	...
	public function enqueue() {
		if ( $this->is_screen_edit() ) {
			wp_enqueue_style( 'mbct-model-edit', ONLINE_SURVEY_ASSETS . 'css/edit.css', [], ONLINE_SURVEY_VER );
			wp_enqueue_script( 'mbct-model-edit', ONLINE_SURVEY_ASSETS . 'js/edit.js', [], ONLINE_SURVEY_VER, true );
		...
		wp_enqueue_style( 'mbct-list-table', ONLINE_SURVEY_ASSETS . 'css/list-table.css', [], ONLINE_SURVEY_VER );
		wp_enqueue_script( 'mbct-list-table', ONLINE_SURVEY_ASSETS . 'js/list-table.js', [ 'jquery' ], ONLINE_SURVEY_VER, true );
