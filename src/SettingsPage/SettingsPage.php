<?php
namespace OnlineSurvey\SettingsPage;
...
class SettingsPage {
	...
	public function enqueue() {
		wp_enqueue_style( 'control-listings', ONLINE_SURVEY_ASSETS . '/settings/settings.css', '', '2.1.5' );
		...
		wp_enqueue_script( 'control-listings', ONLINE_SURVEY_ASSETS . '/settings/settings.js', array( 'jquery' ), '2.1.5', true );
		wp_localize_script( 'control-listings', 'MBSettingsPage', array(
